            ...
            for group in self.param_groups:
                for p in group["params"]:
                    ...
                    if group.get("use_muon", False):
                        self.state[p]["is_initialized"] = True # No stale state needed, just a marker
                    else:
        ...
        for group in self.param_groups:
            ...
            if use_muon:
                ...
                for p in group["params"]:
                    ...
                    # Exp 3: No stale state to save for 2D
...
def run_experiment(optimizer_name, params, tokenizer, epochs=10, wandb_project="Atlas-Experiments"):
    run = wandb.init(
        ...
        name=f"{optimizer_name}_exp3_random",
    ...
    for epoch in range(epochs):
        ...
        csv_file = f"logs/{optimizer_name}_atlas_exp3_logs.csv"
