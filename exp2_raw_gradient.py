            ...
            for group in self.param_groups:
                for p in group["params"]:
                    ...
                    if group.get("use_muon", False):
                        g1 = p.grad.float()
                        self.state[p]["g_stale"] = g1.clone() # Store raw gradient
                    else:
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                if stale_key in state:
                    ...
                    # Normalize to Frobenius/L2 norm 1 so the perturbation norm is exactly rho
        ...
        for group in self.param_groups:
            ...
            if use_muon:
                ...
                for p in group["params"]:
                    ...
                    state["g_stale"] = g_adv.clone() # Exp 2: save raw adversarial gradient
...
def run_experiment(optimizer_name, params, tokenizer, epochs=10, wandb_project="Atlas-Experiments"):
    run = wandb.init(
        ...
        name=f"{optimizer_name}_exp2_raw_grad",
    ...
    for epoch in range(epochs):
        ...
        csv_file = f"logs/{optimizer_name}_atlas_exp2_logs.csv"
